...
- (void)viewDidLoad {
    ...
    SFSafariViewController *vc = [[SFSafariViewController alloc] initWithURL:[NSURL URLWithString:@"http://www.baidu.com"] entersReaderIfAvailable:YES];
    vc.delegate = self;
